                                                ...
                                                <tr style="border-collapse:collapse;">
                                                    <td width="560" align="center" valign="top" style="padding:0;Margin:0;">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;">
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;"><img src="<?=Yii::$app->params['mail']['imgLogo'];?>" alt="<?=Yii::$app->params['projectName'];?>" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" width="199" title="<?=Yii::$app->params['projectName'];?>"></td>
                                                            </tr>
                                                        </table>
                                                        <? endif; ?>
                                                    </td>
