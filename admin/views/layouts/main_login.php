...
<body class="myls-login" style="background-image: url(<?=Yii::$app->params['bgImg']?>); background-color: <?=Yii::$app->params['bgColor']?>">
<?php $this->beginBody() ?>

<?= $content ?>
<div class="myls-logo"><a href="https://mylscompany.com"><img src="img/myls-logo.svg" alt=""></a></div>
<script>
