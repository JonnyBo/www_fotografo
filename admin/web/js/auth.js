...
class Auth {
    ...
    constructor (page) {
        ...
        switch (this.page) {
            ...
            case 'registration':
                ...
                break;
            case 'regbyuser':
                this.formIdn = 'mylsRegByUserForm';
                break;
            case 'restore':
    ...
    async getUserData(token) {
        if (this.page == 'registration')
            this.userData = await app.processData('/site/regurl-decode', 'POST', {token: token});
        if (this.page == 'regbyuser')
    ...
    async initForm() {
        ...
        if (this.page =='registration' || this.page =='regbyuser') {
