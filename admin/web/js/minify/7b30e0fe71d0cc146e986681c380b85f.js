...
cloneObject(obj){return obj?JSON.parse(JSON.stringify(obj)):undefined;}};;class Auth{constructor(page){this.page=page;this.userData={};this.token='';this.formIdn='';switch(this.page){case'login':this.formIdn='mylsAuthForm';break;case'registration':this.formIdn='mylsRegistrationForm';break;case'restore':this.formIdn='mylsRestoreForm';this.token=app.getUrlParameter('token');if(this.token){$('#form-container').attr('action','restore?token='+this.token);}
break;}}
